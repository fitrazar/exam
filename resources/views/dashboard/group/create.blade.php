...
@section('content')
    <x-breadcrumb title="Tambah Data No Kelas" url="/dashboard/group" prev="Data No Kelas" />
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ url('/dashboard/group') }}" method="POST">
                                @csrf
                                <div class="col-6 mb-3">
                                    <label for="number" class="form-label">No Kelas</label>
                                    <input type="text" class="form-control @error('number') is-invalid @enderror"
                                        id="number" name="number" value="{{ old('number') }}" placeholder="1">
                                    @error('number')
