...
@section('content')
    <x-breadcrumb title="Tambah Data Siswa" url="/dashboard/student" prev="Data Siswa" />
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ url('/dashboard/student') }}" method="POST">
                                @csrf
                                <div class="col-6 mb-3">
                                    <label for="nisn" class="form-label">NISN</label>
                                    <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                                        id="nisn" name="nisn" value="{{ old('nisn') }}" placeholder="xxxxxxxx">
                                    @error('nisn')
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name') }}" placeholder="Fitra Fajar">
                                    @error('name')
                                        <span class="text-danger text-sm" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        id="phone" name="phone" value="{{ old('phone') }}" placeholder="628xxxx">
                                    @error('phone')
                                        <span class="text-danger text-sm" role="alert">
                                            {{ $message }}
                                        </span>
