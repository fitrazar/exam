...
@section('content')
    <x-breadcrumb title="Edit Data Jurusan" url="/dashboard/major" prev="Data Jurusan" />
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ url('/dashboard/major/' . $major->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('acronym') is-invalid @enderror"
                                        id="acronym" name="acronym" value="{{ old('acronym', $major->acronym) }}"
                                        placeholder="TKJ">
                                    @error('acronym')
                                        <span class="text-danger text-sm" role="alert">
                                            {{ $message }}
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" value="{{ old('slug', $major->slug) }}" readonly>
                                    @error('slug')
                                        <span class="text-danger text-sm" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-12 mb-4">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" id="status" name="status"
                                            {{ old('status', $major->status) == true ? ' ' : ' checked' }}>
